        ...
        <div class="card-body">
            <form action="/insertdata" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="lokasi" class="form-control" id="exampleInputLokasi"
                        aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="harga" class="form-control" id="exampleInputHarga" aria-describedby="emailHelp" placeholder="Rp.0">
                </div>
                <div class="mb-3">
